...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    AdminController::createAdmin($name, $email, $hashed_password);
...
<div class="layout">
    ...
    <main class="content">
        ...
        <section class="page">
            <div class="card">
                <div class="card-head">
                    <h2 class="card-title">New Admin</h2>
                </div>

                <form method="post" action="manage_admin_add.php" class="form-block">
                    <div class="grid-2">
                        <label>
                            <span>Name</span>
                    ...
                    <div class="form-actions">
                        ...
                        <button type="submit" class="btn primary">
                            <i class="fa-solid fa-floppy-disk"></i> Create Admin
                        </button>
                    </div>
                </form>
            </div>
