...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    OrganizationUserController::createOrganizationUser($organization_id, $name, $email, $hashed_password);
    ...
    <main class="content">
        ...
        <section class="page">
            <div class="card">
                ...
                <form method="post" action="manage_org_users_add.php" class="form-block">
                    <div class="grid-2">
                        <label>
                            <span>Status</span>
                    ...
                    <div class="grid-2">
                        <label>
                            <span>Password</span>
                            <input type="password" name="password" placeholder="Minimum 6 characters" minlength="6"
                                   required/>
                        </label>

                        <label>
                            <span>Confirm Password</span>
                            <input type="password" name="password_confirm" placeholder="Re-enter password" minlength="6"
                                   required/>
                        </label>
                    </div>
