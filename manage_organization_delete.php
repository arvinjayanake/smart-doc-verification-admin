...
<head>
    <meta charset="utf-8" />
    <title>Smart Doc • Delete Organization</title>
            ...
            <div class="card danger-card">
                ...
                <div class="form-block">
                    <div class="grid-2">
                        <label>
                            <span>Name</span>
                            <input type="text" value="<?php echo $organization['name'] ?>" readonly />
                        </label>

                        <label>
                            <span>Address</span>
                            <input type="text" value="<?php echo $organization['address'] ?>" readonly />
                        </label>
                    </div>
                    ...
                    <div class="grid-2">
                        <label>
                            <span>Mobile</span>
                            <input type="text" value="<?php echo $organization['mobile'] ?>" readonly />
                        </label>

                        <label>
                            <span>Status</span>
                            <input type="text" value="<?php echo $organization['status'] ?>" readonly />
                        </label>
                    </div>
                    ...
                    <!-- Delete form -->
                    <form method="post" action="manage_organization_delete.php?id=<?php echo $id ?>" class="form-actions">
                        <a href="manage_organization.php" class="btn">
